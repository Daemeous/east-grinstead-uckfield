# East Grinstead and Uckfield — Leafletting Map

A canvassing and leafletting tracker for East Grinstead and Uckfield (Westminster constituency, in full — 22 wards across Wealden, Lewes, and Mid Sussex districts). Volunteers can view road-level status, plan routes, and mark progress in real time via a Google Sheets backend.
...
Live: **https://daemeous.github.io/east-grinstead-uckfield/**
